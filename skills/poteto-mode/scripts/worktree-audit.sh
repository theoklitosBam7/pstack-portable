...
# Transcripts dir, when running under Cursor: ~/.cursor/projects/<slugified-repo-path>/agent-transcripts.
# Absent on other harnesses; the LAST_CHAT column then stays empty.
