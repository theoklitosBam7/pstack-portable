...
Use the `architect runners` panel from the pstack model config, per the **harness** skill. Otherwise one runner each on up to four distinct model families you can spawn, the strongest judgment model included.
