...
At the end of the run, before handing back, check the log told the truth. Read this run's transcript, located with the find-transcripts operation in the **harness** skill. Stay inside the active workspace; other projects' transcripts are private chats. Walk the log against what actually happened:
